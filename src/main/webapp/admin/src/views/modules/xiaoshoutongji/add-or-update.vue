          ...
          <el-form-item v-if="ruleForm.shangpinmingcheng" label="商品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="商品名称" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="销售总数" prop="xiaoshouzongshu">
          <el-input v-model="ruleForm.xiaoshouzongshu" 
              placeholder="销售总数" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.xiaoshouzongshu" label="销售总数" prop="xiaoshouzongshu">
              <el-input v-model="ruleForm.xiaoshouzongshu" 
                placeholder="销售总数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='xiaoshouzongshu'){
            this.ruleForm.xiaoshouzongshu = obj[o];
            continue;
          }
                    if(o=='riqi'){
